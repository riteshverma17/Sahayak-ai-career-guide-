...
export default function Dashboard() {
  ...
  function renderIntroHero() {
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      {/* Main AI Hero */}
      <div className="bg-gradient-to-r from-indigo-600 to-pink-500 text-white rounded-xl p-10 shadow-lg">
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1">
            <h1 className="text-4xl font-extrabold mb-2">AI Career Guidance</h1>
            <p className="opacity-90 mb-6 text-lg">Get highly personalized, AI-powered course and career recommendations based on your performance, aptitude, and interests. Join thousands of students making data-driven paths to success.</p>
            <div className="flex gap-3">
              <button onClick={() => setStep(1)} className="px-6 py-3 bg-white text-indigo-600 rounded-full font-bold shadow hover:bg-gray-100 transition">Get Personalized Recommendations</button>
            </div>
          </div>
          <div className="w-48 h-48 bg-white/20 rounded-2xl flex items-center justify-center p-4">
            <div className="text-center">
              <div className="text-5xl mb-2">🤖</div>
              <div className="text-lg font-bold">Sahayak AI</div>
            </div>
          </div>
        </div>
      </div>

      {/* Value & Insights Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition">
          ...
          <h3 className="font-bold text-gray-900 mb-2">Graduation Value & Awareness</h3>
          <p className="text-gray-600 text-sm">Discover the real-world employment rates of different degrees. Understand what skills employers actually want before investing years in a course.</p>
        </div>
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition">
          <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center text-2xl mb-4">🏫</div>
          <h3 className="font-bold text-gray-900 mb-2">Government Colleges Directory</h3>
          <p className="text-gray-600 text-sm">Access a detailed, functional directory of top-tier government institutions. Compare programs, placement stats, and rankings easily.</p>
        </div>
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition">
          <div className="w-12 h-12 bg-green-100 text-green-600 rounded-lg flex items-center justify-center text-2xl mb-4">📊</div>
          <h3 className="font-bold text-gray-900 mb-2">Data-Driven Policy Insights</h3>
          <p className="text-gray-600 text-sm">Aggregated analytics to help educators and policymakers understand skill gaps and student preferences, driving better educational infrastructure.</p>
        </div>
      </div>
    </div>
  )
